      ...
      <div className="relative z-30 w-full max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col min-h-screen justify-between">
          ...
          <div className="flex-1 flex flex-col justify-center space-y-2 pt-0">
            ...
            >
              <p className="text-2xl sm:text-xl lg:text-5xl text-white/95 font-light italic tracking-wide">
            ...
            {/* Partner Logos */}
            <motion.div
              className="flex justify-center items-center space-x-8 sm:space-x-12 mt-8 mb-4"
            ...
            >
              <div className="flex items-center justify-center">
                <img
                  src="/coa.png"
                  alt="COA Logo"
                  className="h-12 sm:h-16 w-auto opacity-90 hover:opacity-100 transition-opacity duration-300"
                />
              </div>
              <div className="flex items-center justify-center">
                <img
